...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    'flex items-center justify-center gap-2 rounded-full font-bold transition-all active:scale-[0.98]';

  const variants = {
    primary: 'bg-primary text-background-dark shadow-lg shadow-primary/25 hover:bg-[#25c464]',
    secondary:
      'bg-white dark:bg-surface-dark border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white',
    ghost:
