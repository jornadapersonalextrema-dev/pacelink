...
function NewWorkoutPage() {
    ...
    const [cooldownEnabled, setCooldownEnabled] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    // Rodagem
    const [rodagemDistanceKm, setRodagemDistanceKm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(5);
    const [rodagemIntensity, setRodagemIntensity] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('moderado');
    // Progressivo (fases)
    ...
    // Alternado
    const [altRepeats, setAltRepeats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(6);
    const [altStrongKm, setAltStrongKm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0.2);
    const [altEasyKm, setAltEasyKm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0.2);
    ...
    const [shareSlug, setShareSlug] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const computed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NewWorkoutPage.useMemo[computed]": ()=>{
            ...
            const now = new Date();
            const addBlock = {
                "NewWorkoutPage.useMemo[computed].addBlock": (b)=>{
                    blocks.push({
                        ...b,
                        index: blocks.length
                    });
                }
            }["NewWorkoutPage.useMemo[computed].addBlock"];
            if (warmupEnabled) {
                addBlock({
                    segment_type: 'warmup',
                    label: 'Aquecimento',
            ...
            if (workoutType === 'progressivo') {
                ...
                template_params = {
                    phases: phases.map({
                        "NewWorkoutPage.useMemo[computed]": (p, idx)=>({
                                order: idx + 1,
            ...
            const total_km = blocks.reduce({
                "NewWorkoutPage.useMemo[computed].total_km": (sum, b)=>sum + (Number(b.distance_km) || 0)
                                ...
                                children: [
                                    ...
                                    workoutType === 'rodagem' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                        children: [
                                            ...
                                            p1kSec && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(NewWorkoutPage, "U3UufNftqD8po3PA36QJuJjXFc4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
