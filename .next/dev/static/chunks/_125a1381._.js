...
function NewWorkoutPage() {
    ...
    const totalKm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NewWorkoutPage.useMemo[totalKm]": ()=>computeTotalKm(includeWarmup ? warmupKm : 0, includeCooldown ? cooldownKm : 0, blocks)
            ...
            async function load() {
                ...
                try {
                    ...
                    if (st?.p1k_sec_per_km) {
                        setBlocks({
                            "NewWorkoutPage.useEffect.load": (prev)=>prev.map({
                                    "NewWorkoutPage.useEffect.load": (b)=>({
                                            ...b,
                                            paceStr: b.paceStr || paceFromIntensity(st.p1k_sec_per_km, b.intensity)
                                        })
                                }["NewWorkoutPage.useEffect.load"])
                        }["NewWorkoutPage.useEffect.load"]);
                    }
                } catch (e) {
                    if (!mounted) return;
...
//# sourceMappingURL=_125a1381._.js.map