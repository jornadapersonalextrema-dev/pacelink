...
function paceRangeFromP1k(p1kSec, intensity) {
    if (!p1kSec || p1kSec <= 0) return null;
    // heurística simples (ajuste fino depois com o Diego)
    const mult = intensity === 'leve' ? [
        1.2,
        1.35
    ] : intensity === 'moderado' ? [
        1.05,
    ...
    const a = Math.round(p1kSec * mult[0]);
    const b = Math.round(p1kSec * mult[1]);
    return [
        a,
        b
    ];
...
function NewWorkoutPage() {
    ...
    const studentId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NewWorkoutPage.useMemo[studentId]": ()=>{
            const raw = params?.id;
    ...
    const [bannerError, setBannerError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [toast, setToast] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [studentLoading, setStudentLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const [warmupKm, setWarmupKm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('2');
    ...
    const totalKm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NewWorkoutPage.useMemo[totalKm]": ()=>{
            const w = includeWarmup ? parseKm(warmupKm) : 0;
            const c = includeCooldown ? parseKm(cooldownKm) : 0;
            const b = blocks.reduce({
                "NewWorkoutPage.useMemo[totalKm].b": (sum, blk)=>sum + parseKm(blk.distanceKm)
            }["NewWorkoutPage.useMemo[totalKm].b"], 0);
            return Math.max(0, w + b + c);
        }
    }["NewWorkoutPage.useMemo[totalKm]"], [
        includeWarmup,
        warmupKm,
    ...
    const titlePlaceholder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NewWorkoutPage.useMemo[titlePlaceholder]": ()=>{
            if (workoutType === 'rodagem') return 'Ex: Rodagem leve';
            if (workoutType === 'progressivo') return 'Ex: Progressivo';
            return 'Ex: Alternado (ex.: 6x400m)';
        }
    }["NewWorkoutPage.useMemo[titlePlaceholder]"], [
        workoutType
    ]);
    // carrega aluno (sem .single() para não dar 406 quando RLS/session falhar)
        ...
        "NewWorkoutPage.useEffect": ()=>{
            ...
            async function load() {
                ...
                try {
                    ...
                    if (!user) {
                        // se não estiver logado, manda pra login (não quebra o app)
                        if (alive) {
                            setBannerError('Você precisa estar logado para criar um treino.');
                            setStudent(null);
                        }
                        return;
                    }
                    const { data, error } = await supabase.from('students').select('id,name,email,p1k_sec_per_km').eq('id', studentId).maybeSingle();
                    if (error) throw error;
                    if (!data) {
                        if (alive) {
                            setBannerError('Aluno não encontrado (ou sem permissão para acessar).');
                            setStudent(null);
                        }
                        return;
                    }
                    ...
                    if (alive) {
                        setStudent(null);
                        setBannerError(e?.message || 'Erro ao carregar aluno.');
                    }
                } finally{
    ...
    function setBlockDistance(id, value) {
    ...
    function setBlockIntensity(id, intensity) {
        setBlocks((prev)=>prev.map((b)=>b.id === id ? {
                    ...b,
                    intensity
                } : b));
    ...
    function validateBeforeSave() {
        if (!studentId) return 'Aluno inválido.';
        if (!blocks.length) return 'Adicione ao menos 1 bloco principal.';
        const invalid = blocks.some((b)=>parseKm(b.distanceKm) <= 0);
        if (invalid) return 'Todos os blocos devem ter distância maior que 0.';
        if (includeWarmup && parseKm(warmupKm) <= 0) return 'A distância do aquecimento deve ser maior que 0.';
        if (includeCooldown && parseKm(cooldownKm) <= 0) return 'A distância do desaquecimento deve ser maior que 0.';
        return null;
    }
    async function handleSaveDraft() {
        ...
        try {
            ...
            const user = userResp?.user;
            if (!user) {
                setBannerError('Sessão expirada. Faça login novamente.');
                router.push('/login');
                return;
            }
            const payload = {
            ...
            setBannerError(e?.message || 'Erro ao salvar rascunho.');
        } finally{
            setBusy(false);
        }
    }
    async function handleShare() {
        // no MVP: primeiro salva rascunho, depois melhora compartilhamento (P1)
        await handleSaveDraft();
        if (!bannerError) {
            setToast('Rascunho salvo. (Compartilhamento será refinado em seguida.)');
        }
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    bannerError ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: studentLoading ? 'Carregando...' : student?.name || '—'
                                        }, void 0, false, {
                                            fileName: "[project]/app/students/[id]/workouts/new/page.tsx",
                                            lineNumber: 291,
                                            columnNumber: 15
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                    className: "mt-3 w-full rounded-xl bg-black/20 px-4 py-3 text-base outline-none ring-1 ring-white/10 focus:ring-2 focus:ring-emerald-400/60",
                                    ...
                                    children: [
                                        ...
                                        'alternado'
                                            ...
                                            className: [
                                                ...
                                                workoutType === t ? 'bg-emerald-400 text-black' : 'bg-black/20 text-white ring-1 ring-white/10 hover:bg-black/30'
                                            ].join(' '),
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "mt-4 rounded-2xl bg-black/10 px-4 py-4 ring-1 ring-white/10",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Icon$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                            name: "flame"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/students/[id]/workouts/new/page.tsx",
                                                            lineNumber: 357,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    ...
                                                    className: [
                                                        ...
                                                        includeWarmup ? 'bg-emerald-400' : 'bg-black/30 ring-1 ring-white/10'
                                                    ].join(' '),
                                            ...
                                            children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                                    ...
                                                                    inputMode: "decimal",
                                                                    className: "w-full rounded-xl bg-black/20 px-4 py-3 text-base outline-none ring-1 ring-white/10 focus:ring-2 focus:ring-emerald-400/60 disabled:opacity-40",
                                                                    value: warmupKm,
                                                                    onChange: (e)=>setWarmupKm(sanitizeKmInput(e.target.value))
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/students/[id]/workouts/new/page.tsx",
                                                                    lineNumber: 384,
                                                                    columnNumber: 21
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "mt-2 rounded-xl bg-black/20 px-4 py-3 text-base ring-1 ring-white/10",
                                                            children: "Livre"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/students/[id]/workouts/new/page.tsx",
                                                            lineNumber: 397,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                blocks.map((blk)=>{
                                                    const range = paceRangeFromP1k(student?.p1k_sec_per_km ?? null, blk.intensity);
                                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "rounded-2xl bg-black/10 px-4 py-4 ring-1 ring-white/10",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                ...
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                                                        inputMode: "decimal",
                                                                                        className: "w-full rounded-xl bg-black/20 px-4 py-3 text-base outline-none ring-1 ring-white/10 focus:ring-2 focus:ring-emerald-400/60",
                                                                                        value: blk.distanceKm,
                                                                                        onChange: (e)=>setBlockDistance(blk.id, e.target.value),
                                                                                        placeholder: "Ex: 1,0"
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/app/students/[id]/workouts/new/page.tsx",
                                                                                        lineNumber: 421,
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                        type: "button",
                                                                        className: "mt-1 rounded-xl bg-black/20 p-2 ring-1 ring-white/10 hover:bg-black/30",
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            range ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                className: "text-xs text-muted-foreground",
                                                                                children: [
                                                                                    "Ritmo sugerido: ",
                                                                                    formatPaceFromSec(range[0]),
                                                                                    "–",
                                                                                    formatPaceFromSec(range[1]),
                                                                                    " /km"
                                                                                ]
                                                                            }, void 0, true, {
                                                                                fileName: "[project]/app/students/[id]/workouts/new/page.tsx",
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            'forte'
                                                                                ...
                                                                                type: "button",
                                                                                onClick: ()=>setBlockIntensity(blk.id, i),
                                                                                className: [
                                                                                    'rounded-full px-3 py-2 text-sm font-semibold transition',
                                                                                    blk.intensity === i ? 'bg-emerald-400 text-black' : 'bg-black/20 text-white ring-1 ring-white/10 hover:bg-black/30'
                                                                                ].join(' '),
                                                                                children: i === 'leve' ? 'Leve' : i === 'moderado' ? 'Moderado' : 'Forte'
                                                                            }, i, false, {
                                                                                fileName: "[project]/app/students/[id]/workouts/new/page.tsx",
                                                                                lineNumber: 455,
                                                                                columnNumber: 29
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    type: "button",
                                                    onClick: addBlock,
                                                    className: "w-full rounded-2xl border border-dashed border-white/20 bg-transparent px-4 py-4 text-center text-sm font-semibold text-white/80 hover:bg-white/5",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "mt-5 rounded-2xl bg-black/10 px-4 py-4 ring-1 ring-white/10",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex items-center justify-between",
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    ...
                                                    className: [
                                                        'h-7 w-12 rounded-full p-1 transition',
                                                        includeCooldown ? 'bg-emerald-400' : 'bg-black/30 ring-1 ring-white/10'
                                                    ].join(' '),
                                                    "aria-checked": includeCooldown,
                                                    role: "switch",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: [
                                                            'h-5 w-5 rounded-full bg-white transition',
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                                    ...
                                                                    className: "w-full rounded-xl bg-black/20 px-4 py-3 text-base outline-none ring-1 ring-white/10 focus:ring-2 focus:ring-emerald-400/60 disabled:opacity-40",
                                                                    value: cooldownKm,
                                                                    onChange: (e)=>setCooldownKm(sanitizeKmInput(e.target.value))
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/students/[id]/workouts/new/page.tsx",
                                                                    lineNumber: 513,
                                                                    columnNumber: 21
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed bottom-0 left-0 right-0 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mx-auto flex max-w-xl gap-3 px-4 py-4",
                    children: [
...
_s(NewWorkoutPage, "HhdzuJAQfQKEUp5bwzTU+KhJxzU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=_414cb4a3._.js.map